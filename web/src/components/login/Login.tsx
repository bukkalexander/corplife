    ...
    case LoginState.VERIFY:
      return (
        <Form onSubmit={handleSubmitVerificationCode}>
          <H1>Sign Up</H1>
          <UsernameInput value={username} onChange={handleUsernameChange} />
          <VerificationCodeInput value={verificationCode} onChange={handleVerificationCodeChange} />
          <br />
          <div className="flex gap-1">
            <Button onClick={() => confirmSignUp({ username, confirmationCode: verificationCode })}>
              Verify
            </Button>
            <Button onClick={handleResendVerificationCode}>Resend Code</Button>
          </div>
